...
install: deps
	...
	@# `make install` installs the editable version of openfisca-korea.
...
build: clean deps
	...
	python -m build
	pip uninstall --yes openfisca-korea
...
test: clean
	openfisca test --country-package openfisca_korea openfisca_korea/tests

serve-local: build
	openfisca serve --country-package openfisca_korea
